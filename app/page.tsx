    ...
    <div className="min-h-screen bg-(--background) flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 text-center max-w-3xl px-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-sm mb-6 text-gray-300">
          ...
          <span>Inteligência Artificial para iridologia</span>
        </div>
        ...
        <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto">
          Simplifique o atendimento. Grave a consulta, transcreva o áudio e deixe a IA extrair sintomas, diagnósticos e gerar anotações instantaneamente.
        </p>
